      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            $sql = "SELECT COUNT(*) AS count FROM tblvehicles";
        ...
        <?php 
        $sql = "SELECT v.*, b.BrandName FROM tblvehicles v JOIN tblbrands b ON b.id = v.VehiclesBrand";
        $query = $dbh->prepare($sql);
        $query->execute();
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
              <?php 
              $sql = "SELECT v.*, b.BrandName FROM tblvehicles v JOIN tblbrands b ON b.id = v.VehiclesBrand ORDER BY v.id DESC LIMIT 4";
              $query = $dbh->prepare($sql);
              $query->execute();
              $recent_cars = $query->fetchAll(PDO::FETCH_OBJ);
              ...
              foreach($recent_cars as $car) { ?>
                <li class="gray-bg">
                  ...
                  <div class="recent_post_title">
                    <a href="vehical-details.php?vhid=<?php echo htmlentities($car->id);?>"><?php echo htmlentities($car->BrandName);?> , <?php echo htmlentities($car->VehiclesTitle);?></a>
