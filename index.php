      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="car-listing.php" class="btn">BOOK NOW<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row"> 
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="resentnewcar">
          <div class="row">
            <?php 
            $sql = "SELECT v.VehiclesTitle, b.BrandName, v.PricePerDay, v.FuelType, v.ModelYear, v.id, v.SeatingCapacity, v.VehiclesOverview, v.Vimage1 FROM tblvehicles v JOIN tblbrands b ON b.id = v.VehiclesBrand";
  ...
  <div class="container div_zindex">
    ...
    <div class="row">
      <div id="testimonial-slider">
        <?php 
        $tid = 1;
        $sql = "SELECT t.Testimonial, u.FullName FROM tbltestimonial t JOIN tblusers u ON t.UserEmail = u.EmailId WHERE t.status = :tid";
        $query = $dbh->prepare($sql);
        ...
        <div class="testimonial-m">
          <div class="testimonial-content" style="width: 300px; height: 200px;">
